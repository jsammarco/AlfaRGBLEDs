...
class ConsoleViewController: UIViewController {
    ...
    @IBOutlet weak var knightRiderBtn: UIButton!
    @IBOutlet weak var knightRider2Btn: UIButton!
    @IBOutlet weak var demoReelBtn: UIButton!
    ...
    @IBAction func knightRiderBtn(_ sender: Any) {
        sendMsg(msg: "K\n");
    }
    
    @IBAction func knightRider2Btn(_ sender: Any) {
        sendMsg(msg: "2\n");
    }
  
    @IBAction func demoReelBtn(_ sender: Any) {
        sendMsg(msg: "D\n");
    }
    ...
    @IBAction func brightnessChanged(_ sender: Any) {
        var valueString = String(Int(brightnessSlider.value))
        valueString = "B\(valueString)\n"
        print(valueString)
        sendMsg(msg: valueString);
    }
...
//    }
  ...
  @objc func appendRxDataToTextView(notification: Notification) -> Void{
    print("[Recv]: \(notification.object!) ") // \n
    consoleTextView.text.append("\(notification.object!) ")//[Recv]:
  }
